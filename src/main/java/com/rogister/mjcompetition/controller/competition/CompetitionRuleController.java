...
import com.rogister.mjcompetition.service.competition.CompetitionRuleService;
...
public class CompetitionRuleController {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<CompetitionRule>> updateCompetitionRule(@PathVariable Long id,
