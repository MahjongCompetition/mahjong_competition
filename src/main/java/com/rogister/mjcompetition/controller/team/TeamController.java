package com.rogister.mjcompetition.controller.team;

import com.rogister.mjcompetition.dto.common.ApiResponse;
import com.rogister.mjcompetition.dto.team.TeamCreateRequest;
import com.rogister.mjcompetition.dto.team.TeamOperationRequest;
...
public class TeamController {
    ...
    public ResponseEntity<ApiResponse<Team>> createTeam(
        ...
        try {
            ...
            if (teamName == null || maxMembers == null) {
     ...
     */
    @PostMapping("/join")
    public ResponseEntity<ApiResponse<Team>> joinTeam(@RequestBody TeamOperationRequest request,
            HttpServletRequest httpRequest) {
        try {
            // 从JWT token中获取当前玩家
     ...
     */
    @PostMapping("/leave")
    public ResponseEntity<ApiResponse<String>> leaveTeam(@RequestBody TeamOperationRequest request,
            HttpServletRequest httpRequest) {
        try {
            // 从JWT token中获取当前玩家
            Player player = getCurrentPlayer(httpRequest);
